...
//SLIDER DE PRODUCTOS
var contenedor = document.querySelector('.slider'), //query selector selecciona el ID u otros
    btnIzquierdo = document.getElementById("btn-izquierda"),
    btnDerecho = document.getElementById("btn-derecha");

    //EVENTO PARA EL BOTON DERECHO
    btnDerecho.addEventListener("click", function(){
        contenedor.scrollLeft += contenedor.offserWidth;
    });
...
var formulario = document.getElementById("formulario");
    ...
    function validar(e){
        var inputNombre = document.getElementById("nombre"),
            ...
            inputComents = document.getElementById("comentario"),
...
// DETECTAMOS EVENTO CLIC EN EL LOGO
